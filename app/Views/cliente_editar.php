    ...
    <div class="container mt-5">
        ...
        <form method='post'>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Seu Nome" value="<?php echo $clientes->nome ?>">
            </div>

            <!-- Campo Email -->
            <div class="form-group">
                <label for="email">Email address</label>
                <input type="email" class="form-control" id="email" name="email" placeholder="name@example.com" value="<?php echo $clientes->email ?>">
            </div>

            <!-- Campo Telefone -->
            <div class="form-group">
                <label for="telefone">Telefone</label>
                <input type="text" class="form-control" id="telefone" name="telefone" placeholder="(99) 99999-9999" value="<?php echo $clientes->telefone ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" id="endereco_cep" name="endereco_cep" placeholder="XXXXX-XXX" value="<?php echo $clientes->endereco_cep ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="endereco_rua" name="endereco_rua" placeholder="Nome da Rua" value="<?php echo $clientes->endereco_rua ?>">
            </div>

            <div class="form-group">
                <label for="endereco_logradouro">Logradouro</label>
                <input type="text" class="form-control" id="endereco_logradouro" name="endereco_logradouro" placeholder="Logradouro" value="<?php echo $clientes->endereco_logradouro ?>">
            </div>

            <div class="form-group">
                <label for="endereco_bairro">Bairro</label>
                <input type="text" class="form-control" id="endereco_bairro" name="endereco_bairro" placeholder="Bairro" value="<?php echo $clientes->endereco_bairro ?>">
            </div>

            <div class="form-group">
                <label for="endereco_uf">UF</label> 
                <input type="text" class="form-control" id="endereco_uf" name="endereco_uf" placeholder="UF" value="<?php echo $clientes->endereco_uf ?>">
            </div>
